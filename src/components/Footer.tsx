    ...
    return (
        <footer className="my-10">
            ...
            <div className="container mx-auto">
                <div className="flex flex-col md:flex justify-between pt-1 pl-2.5 pr-2.5 mb-10 gap-3">
                ...
                <div className="flex flex-col md:flex justify-between  pl-2.5 pr-2.5 mt-10">
